...
let g:colors_name="vilight-cterm"
...
hi Search         guifg=#eedd82 ctermfg=222           guibg=NONE        gui=underline
...
hi MatchParen	    guifg=#ffffff	ctermfg=15            guibg=#6c8095 		ctermbg=66     	gui=NONE
"hi ErrorMsg	      guifg=#cf6a4c ctermfg=167           guibg=NONE        gui=NONE
hi ErrorMsg	      guifg=#212121 ctermfg=234           guibg=NONE        gui=NONE
hi WarningMsg	    guifg=#eedd82 ctermfg=222           guibg=NONE        gui=NONE
hi Title	        guifg=#cf6a4c	ctermfg=167           guibg=NONE        gui=NONE
hi SpecialKey     guifg=#424242 ctermfg=238           guibg=NONE

"Syntax hilight groups

hi Comment        guifg=#646959 ctermfg=241           gui=italic
hi Constant       guifg=#7587a6 ctermfg=103           gui=NONE
